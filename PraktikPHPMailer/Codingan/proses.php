...
try {
    ...
    // EMAIL PENGIRIM
    $mail->Username   = 'tesfianradit@gmail.com';
    $mail->Password   = 'tinr jpgs exuo ohfz'; // isi app password gmail

    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // PENGIRIM & PENERIMA
    $mail->setFrom('tesfianradit@gmail.com', 'Alert PHPMailer');
    $mail->addAddress('desfianmaulana12@gmail.com');
